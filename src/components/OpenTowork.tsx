        ...
        animations: [
          {
            elements: {
              e6s3ziwt2WH2: {
                transform: {
                  data: { o: { x: 16, y: 16, type: 'corner' } },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 1000, v: { x: 3.2, y: 3.2 } },
                    ],
                  },
                },
                opacity: [
            ...
            s: '',
          },
        ],
        options: 'MODAxMDg4MmY4MDgxNmTU3ZlY4MTJmNDcyZjcE5N2M2ZTcxMmY4YQ|',
      },
      '__SVGATOR_PLAYER__',
      window,
      document
    ...
    <div className='openToWork'>
      <div className='signal'>
        ...
        >
          <defs>
            <radialGradient
              id='e6s3ziwt2WH2-fill'
              cx='0'
              cy='0'
              r='1'
              spreadMethod='pad'
              gradientUnits='userSpaceOnUse'
              gradientTransform='matrix(0 5 -5 0 0 0)'
            >
              <stop id='e6s3ziwt2WH2-fill-0' offset='0%' stop-color='#6efc6c' />
              <stop
                id='e6s3ziwt2WH2-fill-1'
                offset='100%'
                stop-color='#6efc6c'
              />
            </radialGradient>
          ...
          <circle
            ...
            fill='url(#e6s3ziwt2WH2-fill)'
          />
          <circle r='5' transform='translate(16 16)' fill='#6efc6c' />
        </svg>
      </div>
